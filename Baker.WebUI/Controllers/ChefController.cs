...
namespace Baker.WebUI.Controllers
{
    public class ChefController : Controller
    {
        ...
        //HTTP->İnternetteki cıhazların birbir ile konuşmasını sağlayan protokol
        //HTTPCLİENT->aPIYE HTTP İSTEKLERİNİ GÖNDERMEMİZ için kullanıyoruz
        ...
        public async Task<IActionResult> ChefList()
        {
            ...
            var response = await client.GetAsync("https://localhost:7021/api/Chef");
        ...
        public async Task<IActionResult> CreateChef(CreateChefDto model)
        {
            ...
            var response = await client.PostAsync("https://localhost:7021/api/Chef", content);
        ...
        {
            var client=_httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:7021/api/Chef/" + id);
        ...
        public async Task<IActionResult> UpdateChef(int id,UpdateChefDto model)
        {
            ...
            var response = await client.PutAsync("https://localhost:7021/api/Chef" ,content);
